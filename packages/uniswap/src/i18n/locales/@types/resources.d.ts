interface Resources {
  "en-US": {
    ...
    "extension.lock.password.reset.initial.help": "Get help",
    "extension.lock.password.reset.initial.title": "Forgot password",
    "extension.lock.password.reset.resetting.description": "Follow the instructions on the browser web page to reset your password",
    "extension.lock.password.reset.resetting.title": "Reset wallet",
    ...
    "extension.network.notSupported": "This network is not yet supported. More coming soon!",
    ...
    "notification.transfer.pending": "{{currencySymbol}} transfer pending",
    ...
    "onboarding.wallet.description.existing": "Check out your tokens and NFTs, follow crypto wallets, and stay up to date on the go.",
    ...
    "onboarding.wallet.description.new": "Your personal space for tokens, NFTs, and all your trades.",
    ...
    "qrScanner.wallet.title": "You can receive tokens & NFTs on Ethereum, Polygon, Arbitrum, Optimism, Base, Blast, and BNB Chain.",
    ...
    "send.status.fail.description": "Keep in mind that the network fee is still charged for failed transfers.",
    ...
    "settings.setting.backup.password.error.weak": "Weak password",
    ...
    "settings.setting.language.description": "Uniswap defaults to your device‘s language settings. To change your preferred language, go to “Uniswap” in your device settings and tap on “Language”",
    ...
    "swap.form.warning.output.fotFees": "{{fotCurrencySymbol}} fees don’t allow for accurate exact outputs. Use the {{inputCurrencySymbol}} field instead.",
    ...
    "swap.settings.routingPreference.option.default.description": "The Uniswap client selects the best trade type factoring price and network costs.",
    "swap.settings.routingPreference.option.default.title": "Default trade",
    "swap.settings.routingPreference.option.v2.title": "v2 pools only",
    "swap.settings.routingPreference.option.v3.title": "v3 pools only",
    ...
    "swap.settings.slippage.input.receive.formatted": "<text>Receive at least </text><highlight>{{amount}} {{tokenSymbol}}</highlight>",
    "swap.settings.slippage.input.receive.unformatted": "Receive at least {{amount}} {{tokenSymbol}}",
    ...
    "swap.settings.slippage.output.spend.formatted": "<text>Spend at most </text><highlight>{{amount}} {{tokenSymbol}}</highlight>",
    "swap.settings.slippage.output.spend.unformatted": "Spend at most {{amount}} {{tokenSymbol}}",
    ...
    "swap.warning.insufficientGas.cta.button": "Buy {{currencySymbol}}",
    "swap.warning.insufficientGas.cta.message": "You need more <highlight>{{currencySymbol}}</highlight> to cover the network cost for this transaction.",
    ...
    "token.priceExplorer.timeRangeLabel.all": "All",
    ...
    "transaction.action.cancel.description": "If you cancel this transaction before it’s processed by the network, you’ll pay a new network fee instead of the original one.",
    ...
    "unicons.banner.button": "Got it",
    "unicons.banner.subtitle": "We gave your wallet’s unique Unicon a makeover. Check out the rest of your accounts to see your upgraded icons.",
    "unicons.banner.title": "Your Unicon got a new look",
    ...
    "walletConnect.error.unsupported.message": "Make sure that you’re scanning a valid WalletConnect or Ethereum address QR code before trying again.",
